...
class ApplicationHelperTest < ActionView::TestCase
  ...
  test 'time_ago_in_nicer_words' do
    ...
    assert_equal time_ago_in_nicer_words(last_day_of_last_years_may), 'last year'
    assert_equal time_ago_in_nicer_words(last_day_of_last_years_may.beginning_of_month), 'last year'
